...
import { queryRule } from '../pages/manageUserAudit/manage-user-audit/service';

import { TableListData, ArgStatus } from '../pages/manageUserAudit/manage-user-audit/data.d';
