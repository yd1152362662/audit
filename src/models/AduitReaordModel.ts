 ...
 * @LastEditors: yangdan
 * @LastEditTime: 2019-09-17 14:52:10
 * @Description: 添加描述
 */
import { Reducer } from 'redux';
import { Effect } from 'dva';
import { queryRule } from '../pages/manageUserAudit/manage-audit-record/service';
import { TableListData, ArgStatus } from '../pages/manageUserAudit/manage-audit-record/data.d';
...
const Model: ModelType = {
  namespace: 'globalReaordTableList',
  state: {
    dataUser: {
      list: [],
      pagination: {},
